...
MovePick_MAIN_SEARCH:
		...
		ret
	      ...
	      align   16, MovePick_GOOD_CAPTURES
...
MovePick_QUIETS:
		...
		ret
	      ...
	      align   16, MovePick_BAD_CAPTURES
    .WhileDone:
