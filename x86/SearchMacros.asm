...
._9NoTTMove:	mov   qword[rbx+State.stage], r15
...
._12done:
    ...
    if ((RootNode = 0) & (USE_MATEFINDER eq 0)) | ((PvNode = 0) & (USE_MATEFINDER eq 1))
...
._13done:
	...
	@@:
		...
		mov   edi, dword[Reductions+4*(rcx+2*64*64*PvNode)]
	       ...
	       test   r8l, r8l
		 jz   ._15NotCaptureOrPromotion
		xor   eax, eax
	       test   edi, edi
	      setnz   al
		sub   edi, eax
		jmp   ._15ReadyToSearch

._15NotCaptureOrPromotion:
